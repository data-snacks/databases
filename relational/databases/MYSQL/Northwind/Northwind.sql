...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2017 a las 15:07:08
...
--
-- Estructura de tabla para la tabla `employee_privileges`
--
...
--
-- Volcado de datos para la tabla `employee_privileges`
--
...
--
-- Volcado de datos para la tabla `inventory_transactions`
--
...
--
-- Estructura de tabla para la tabla `inventory_transaction_types`
--
...
--
-- Volcado de datos para la tabla `inventory_transaction_types`
--
...
--
-- Estructura de tabla para la tabla `orders_tax_status`
--
...
--
-- Volcado de datos para la tabla `orders_tax_status`
--
...
--
-- Estructura de tabla para la tabla `order_details_status`
--
...
--
-- Volcado de datos para la tabla `order_details_status`
--
...
--
-- Estructura de tabla para la tabla `purchase_order_status`
--
...
--
-- Volcado de datos para la tabla `purchase_order_status`
--
...
--
-- Indices de la tabla `employee_privileges`
--
...
--
-- Indices de la tabla `inventory_transaction_types`
--
...
--
-- Indices de la tabla `orders_tax_status`
--
...
--
-- Indices de la tabla `order_details_status`
--
...
--
-- Indices de la tabla `purchase_order_status`
--
...
--
-- AUTO_INCREMENT de la tabla `strings`
--
ALTER TABLE `strings`
...
--
-- Filtros para la tabla `employee_privileges`
--
ALTER TABLE `employee_privileges`
